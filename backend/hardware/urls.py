...
from .views import HardwareViewSet, RentalViewSet, AdminHardwareViewSet, AdminUserViewSet, UserMeView, semantic_search
...
urlpatterns = [
    path('hardware/semantic-search/', semantic_search, name='semantic-search'),
